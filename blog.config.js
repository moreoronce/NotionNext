...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Yawata', // 您的昵称 例如 tangly1024
  ...
  CONTACT_TELEGRAM: process.env.NEXT_PUBLIC_CONTACT_TELEGRAM || 'https://telegram.me/lexparsimoniae', // 你的telegram 地址 例如 https://t.me/tangly_1024
  ...
  POSTS_SHARE_SERVICES:
    ...
    'link,wechat,weibo,facebook,twitter,telegram,reddit', // 分享的服務，按顺序显示,逗号隔开
  ...
  ANALYTICS_GOOGLE_ID: process.env.NEXT_PUBLIC_ANALYTICS_GOOGLE_ID || 'GTM-K98962QX', // 谷歌Analytics的id e.g: G-XXXXXXXXXX
