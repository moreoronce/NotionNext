...
function handleDataBeforeReturn(db) {
  ...
  if (siteConfig('THEME', BLOG.THEME, db.NOTION_CONFIG) === 'deeprouter') {
    db.allNavPages = cleanClientLinkPages(db.allNavPages)
    db.allLinkPages = cleanClientLinkPages(db.allLinkPages)
  }
...
function cleanClientLinkPages(pages) {
