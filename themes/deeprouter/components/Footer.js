            ...
            <div className="max-w-7xl mx-auto px-4">
                            ...
                            {notice && notice.blockMap ? (
                                ...
                                <>
                                    <p className="text-[#4A4A4A]">
                                        <span className="text-[#9a3412]">#</span> SkillSMP
                                    </p>
                ...
                <div className="border-t border-[#E5E5E5] pt-6">
                    <div className="font-mono text-xs text-[#666666] text-center">
                        ...
                        <span>Powered by <a href="https://github.com/tangly1024/NotionNext" target="_blank" rel="noopener noreferrer" className="text-[#9a3412] font-bold underline decoration-1 hover:text-[#ea580c]">NotionNext</a></span>
                        <span className="text-[#9a3412] ml-2">*/</span>
                    </div>
                </div>
            </div>
        </footer>
