                            ...
                            <TerminalCard title={siteConfig('DEEPROUTER_FOLLOW_CARD_TITLE', 'follow-me.sh', CONFIG)} readonly>
                                <div className='text-sm font-mono'>
                                    ...
                                    <a
                                        ...
                                        className='twitter-btn inline-flex items-center gap-2 py-2 px-4 bg-black hover:bg-[#1a1a1a] text-white rounded transition-colors'
                                    >
                                        <svg className='w-4 h-4' viewBox='0 0 24 24' fill='currentColor' aria-hidden='true'>
                                            <path d='M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z' />
                                        </svg>
                                        <span className='font-semibold'>Follow</span>
                                        <span className='opacity-80'>@{twitterHandle}</span>
                                    </a>
                                </div>
                            </TerminalCard>
                        </div>
